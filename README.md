...
1. [Stack](https://github.com/albinj12/Go-Data-Structures/tree/main/stack)
   - [Stack using array](https://github.com/albinj12/Go-Data-Structures/blob/main/stack/main.go)
   - [Stack using Linked list](https://github.com/albinj12/Go-Data-Structures/blob/main/stack/stack_linked_list.go)
2. [Queue](https://github.com/albinj12/Go-Data-Structures/tree/main/Queue)
   - [Simple Queue](https://github.com/albinj12/Go-Data-Structures/blob/main/Queue/queue.go)
   - [Circular Queue](https://github.com/albinj12/Go-Data-Structures/blob/main/Queue/circular_queue.go)
   - [Queue using Linked list](https://github.com/albinj12/Go-Data-Structures/blob/main/Queue/queue_linked_list.go)
   - [Circular Queue using Linked list](https://github.com/albinj12/Go-Data-Structures/blob/main/Queue/circular_queue_linked_list.go)
   - [Prioriy Queue using linked list](https://github.com/albinj12/Go-Data-Structures/blob/main/Queue/priority_queue_linked_list.go)
3. [Linked List](https://github.com/albinj12/Go-Data-Structures/tree/main/Linked%20List)
   - [Single Linked List](https://github.com/albinj12/Go-Data-Structures/blob/main/Linked%20List/linked_list.go)
